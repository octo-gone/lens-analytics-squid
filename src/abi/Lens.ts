...
export const events = {
    ...
    Collected: new LogEvent<([collector: string, profileId: bigint, pubId: bigint, rootProfileId: bigint, rootPubId: bigint, collectModuleData: string, timestamp: bigint] & {collector: string, profileId: bigint, pubId: bigint, rootProfileId: bigint, rootPubId: bigint, collectModuleData: string, timestamp: bigint})>(
    ...
    FollowsToggled: new LogEvent<([owner: string, profileIds: Array<bigint>, enabled: Array<boolean>, timestamp: bigint] & {owner: string, profileIds: Array<bigint>, enabled: Array<boolean>, timestamp: bigint})>(
    ...
    ProfileMetadataSet: new LogEvent<([profileId: bigint, metadata: string, timestamp: bigint] & {profileId: bigint, metadata: string, timestamp: bigint})>(
