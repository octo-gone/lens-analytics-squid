module.exports = class Data1694344214843 {
    name = 'Data1694344214843'

    async up(db) {
        await db.query(`CREATE TABLE "collect" ("id" character varying NOT NULL, "collector_address" text NOT NULL, "collector_profile_id" numeric, "profile_id" numeric NOT NULL, "pub_id" numeric NOT NULL, "root_profile_id" numeric NOT NULL, "root_pub_id" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "collector_id" character varying, "pub_creator_id" character varying, "publication_id" character varying, "root_creator_id" character varying, "root_publication_id" character varying, CONSTRAINT "PK_48dc0a6d1738eb0ee8f1e13d3d1" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_4b283bb81e853c5ea147f96ec7" ON "collect" ("collector_address") `)
        await db.query(`CREATE INDEX "IDX_0b622ca51bdaaa4037f0b03e64" ON "collect" ("collector_profile_id") `)
        ...
        await db.query(`CREATE TABLE "follow" ("id" character varying NOT NULL, "follower_address" text NOT NULL, "follower_profile_id" numeric, "profile_ids" text array, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "follower_id" character varying, CONSTRAINT "PK_fda88bc28a84d2d6d06e19df6e5" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_b0721bf62c56b44978483f8893" ON "follow" ("follower_address") `)
        await db.query(`CREATE INDEX "IDX_13a85641626872741923a6ab53" ON "follow" ("follower_profile_id") `)
        ...
        await db.query(`ALTER TABLE "follow" ADD CONSTRAINT "FK_e65ef3268d3d5589f94b09c2373" FOREIGN KEY ("follower_id") REFERENCES "profile"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    }

    async down(db) {
        await db.query(`DROP TABLE "collect"`)
        await db.query(`DROP INDEX "public"."IDX_4b283bb81e853c5ea147f96ec7"`)
        await db.query(`DROP INDEX "public"."IDX_0b622ca51bdaaa4037f0b03e64"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_13a85641626872741923a6ab53"`)
